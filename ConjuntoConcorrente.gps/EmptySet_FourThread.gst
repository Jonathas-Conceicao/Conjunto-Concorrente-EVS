...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="EmptySet_FourThread">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n7">
        ...
        <node id="n17">
            <attr name="layout">
                <string>70 575 51 17</string>
            </attr>
        </node>
        <node id="n18">
            <attr name="layout">
                <string>80 675 26 17</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>379 570 51 17</string>
            </attr>
        </node>
        <node id="n20">
            <attr name="layout">
                <string>389 670 26 17</string>
            </attr>
        </node>
        <edge from="n7" to="n7">
            <attr name="label">
